...
const startMarker = '// Category search functionality for header';
const endMarker = '/* Shireen Bakers Functionality */';
...
\;
    ...
    content = content.substring(0, startIndex) + newSearchLogic + content.substring(endIndex);
